...
task turnClockwise()//ghost tracking
{
	while(true)
	{
		if(currHeading >= 5 && currHeading <= 355)
		{
			//PlaySound(soundBlip);
...
{
	while(currHeading >= 1 || currHeading >= 359)
	{
		motorTrigger(frontright,0,-0,-60);
		motorTrigger(backright,-0,-0,-60);
		motorTrigger(frontleft,0,0,-60);
		motorTrigger(backleft,-0,0,-60);
	}
}
...
task main()
{
	...
	*/
	...
	while(true)
	{
		wait1Msec(2000); //here for post processing
  }
	/*
	while(true)
	{
